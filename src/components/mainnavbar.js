      ...
      <Helmet>
        ...
        <Navbar dark expand="md" className="bg_iro_red">
          ...
          <img src={logo} className={[styles.logo, "d-inline-block align-top"].join(" ")} alt=""/>
            <span className={[styles.bg_iro_red, styles.text_font_default, styles.font_variant_smallcaps, styles.font_title, "title-break"].join(" ")}>Igreja </span><span className={[styles.bg_iro_red, styles.text_font_default, styles.font_variant_smallcaps, styles.font_title, "title-break"].join(" ")}> Reformada Ortodoxa</span>
          </NavbarBrand>
